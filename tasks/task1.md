...
오픈소스 기여의 시작은 기여하고자 하는 리포지토리를 내 계정으로 클론하는 것부터 시작됩니다. 클론가 완료되면 내 GitHub 계정에서 클론한 리포지토리의 주소를 확인할 수 있습니다.
...
upstream 리포지토리에 있는 최신 변경분을 로컬 리포지토리에 가져오는 방법은 다양합니다. 가장 쉬운 방법은 git pull 명령어를 사용하는 것입니다. pull은 fetch와 merge 를 합한 명령어입니다.
